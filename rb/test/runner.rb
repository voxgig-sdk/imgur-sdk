...
module ImgurTestRunner
  ...
  def self.env_override(m)
    live = getenv("IMGUR_TEST_LIVE")
    override = getenv("IMGUR_TEST_OVERRIDE")
    ...
    explain = getenv("IMGUR_TEST_EXPLAIN")
    m["IMGUR_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = ImgurTestRunner
Helpers = ImgurHelpers
Vs = VoxgigStruct
