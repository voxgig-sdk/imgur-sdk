...
class ImageEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set IMGUR_TEST_IMAGE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def image_basic_setup(extra)
  ...
  entid_env_raw = ENV["IMGUR_TEST_IMAGE_ENTID"]
