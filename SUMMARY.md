...
Results: Successful response with image details.
...
Results: Successful response with post metadata.
...
| PostMeta | `list` | `GET /post/{postId}/meta` | See reference |

## Connect to the API

- Imgur API Server: `https://imgur.com`
...
- `imgur_list`: List records for an entity. Supported entities: `post_meta`.
- `imgur_load`: Load one record for an entity. Supported entities: `image`.
