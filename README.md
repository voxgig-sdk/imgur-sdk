...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/imgur` | `npm install @voxgig-sdk/imgur` |
| Python | `voxgig-sdk-imgur` | `pip install voxgig-sdk-imgur` |
| PHP | `voxgig-sdk/imgur` | `composer require voxgig-sdk/imgur` |
| Golang | `github.com/voxgig-sdk/imgur-sdk/go` | `go get github.com/voxgig-sdk/imgur-sdk/go` |
| Ruby | `voxgig-sdk-imgur` | `gem install voxgig-sdk-imgur` |
| Lua | `voxgig-sdk-imgur` | `luarocks install voxgig-sdk-imgur` |
