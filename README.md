...
This API provides access to the functionalities of Imgur, allowing users to find, rate, and share memes and images from the platform.

Learn more about Imgur API at [imgur.com](https://imgur.com).

This is an unofficial SDK for the Imgur public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — Image and PostMeta — that you
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/imgur-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/imgur-sdk/releases) |
| Python | `voxgig-sdk-imgur` | publish pending — [install from git tag](https://github.com/voxgig-sdk/imgur-sdk/releases) |
| PHP | `voxgig-sdk/imgur` | publish pending — [install from git tag](https://github.com/voxgig-sdk/imgur-sdk/releases) |
| Golang | `github.com/voxgig-sdk/imgur-sdk/go` | `go get github.com/voxgig-sdk/imgur-sdk/go@latest` |
| Ruby | `voxgig-sdk-imgur` | publish pending — [install from git tag](https://github.com/voxgig-sdk/imgur-sdk/releases) |
| Lua | `voxgig-sdk-imgur` | publish pending — [install from git tag](https://github.com/voxgig-sdk/imgur-sdk/releases) |
| Go CLI | `github.com/voxgig-sdk/imgur-sdk/go-cli` | `go install github.com/voxgig-sdk/imgur-sdk/go-cli/cmd/imgur@latest` |
| Go MCP server | `github.com/voxgig-sdk/imgur-sdk/go-mcp` | `go get github.com/voxgig-sdk/imgur-sdk/go-mcp@latest` |
...
| --- | --- | --- |
| **Image** | The Image entity (load). | `/images/{imageId}` |
| **PostMeta** | The PostMeta entity (list). | `/post/{postId}/meta` |
...
- Upstream API: [https://github.com/l0v3m0n3y/imgur](https://github.com/l0v3m0n3y/imgur)
