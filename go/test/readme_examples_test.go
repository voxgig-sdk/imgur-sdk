...
const testSeed = `map[string]any{"entity": map[string]any{"image": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "post_meta": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
