...
func (sdk *ImgurSDK) OptionsMap() map[string]any {
...
func (sdk *ImgurSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ImgurSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ImgurSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ImgurSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ImgurSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ImgurSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ImgurSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ImgurSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ImgurSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ImgurSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
