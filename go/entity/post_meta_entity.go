...
type PostMetaEntity struct {
	name    string
	client  *core.ImgurSDK
...
func NewPostMetaEntity(client *core.ImgurSDK, entopts map[string]any) *PostMetaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PostMetaEntity) GetName() string { return e.name }
...
func (e *PostMetaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PostMetaEntity) Deleted() bool {
	return e.deleted
}


func (e *PostMetaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPostMetaEntity(e.client, opts)
}

func (e *PostMetaEntity) Data(args ...any) any {
...
func (e *PostMetaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PostMeta; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PostMetaEntity) DataTyped(data ...PostMeta) PostMeta {
	if len(data) > 0 {
		return typedFrom[PostMeta](e.Data(asMap(data[0])))
	}
	return typedFrom[PostMeta](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PostMeta (all fields
// optional at the wire level).
func (e *PostMetaEntity) MatchTyped(match ...PostMeta) PostMeta {
	if len(match) > 0 {
		return typedFrom[PostMeta](e.Match(asMap(match[0])))
	}
	return typedFrom[PostMeta](e.Match())
}
...
func (e *PostMetaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PostMetaEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PostMetaEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PostMetaListMatch and returns []PostMeta. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PostMetaEntity) ListTyped(reqmatch PostMetaListMatch, ctrl map[string]any) ([]PostMeta, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[PostMeta](res), nil
}



func (e *PostMetaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PostMetaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PostMetaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PostMetaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
