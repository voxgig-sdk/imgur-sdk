...
The Golang SDK for the Imgur API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
## Install
```bash
go get github.com/voxgig-sdk/imgur-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/imgur-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/imgur-sdk/go=../imgur-sdk/go
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *ImgurSDK
```
...
| `Image` | `(data map[string]any) ImgurEntity` | Create an Image entity instance. |
| `PostMeta` | `(data map[string]any) ImgurEntity` | Create a PostMeta entity instance. |

### Entity interface (ImgurEntity)

All entities implement the `ImgurEntity` interface.
...
```
github.com/voxgig-sdk/imgur-sdk/go/
├── imgur.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/imgur-sdk/go`) re-exports everything needed
