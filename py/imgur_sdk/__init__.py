...
from imgur_sdk.utility import register

# Load features
from imgur_sdk.feature.base_feature import ImgurBaseFeature
from imgur_sdk.features import _has_feature, _make_feature
...
class ImgurSDK:
    ...
    def get_utility(self):
        return ImgurUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ImgurSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Image(self, data=None) -> "ImageEntity":
        ...
        from imgur_sdk.entity.image_entity import ImageEntity
    ...
    def PostMeta(self, data=None) -> "PostMetaEntity":
        ...
        from imgur_sdk.entity.post_meta_entity import PostMetaEntity
