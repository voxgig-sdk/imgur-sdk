...
from imgur_sdk.core.control import ImgurControl
...
from imgur_sdk.core.helpers import get_ctx_prop, to_map
...
class ImgurContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, ImgurResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ImgurError(code, msg, self)
