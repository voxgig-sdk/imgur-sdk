...
from imgur_sdk.core.spec import ImgurSpec
from imgur_sdk.core.result import ImgurResult
from imgur_sdk.core.response import ImgurResponse
from imgur_sdk.core.operation import ImgurOperation
from imgur_sdk.core.error import ImgurError
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = ImgurSDK.test(None, None)
        ...
        class TestInitFeature(ImgurBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(ImgurBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ImgurSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ImgurSDK.test(None, setup_opts)
