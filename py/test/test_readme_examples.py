# Imgur SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ImgurSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ImgurSDK(...) and ImgurSDK.test(...) become
#      ImgurSDK.test({"entity": {...}}) seeding one mock record (id "test01")
