...
The Python SDK for the Imgur API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/imgur-sdk/releases)) or
...
```python
post_metas = client.PostMeta().list({"id": "example"})
```
