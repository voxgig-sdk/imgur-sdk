...
class ImgurClienttrackFeature extends ImgurBaseFeature
{
    ...
    public function PostConstruct(ImgurContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Imgur-SDK';
