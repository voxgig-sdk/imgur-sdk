...
// Imgur SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ImgurTestFeature extends ImgurBaseFeature
{
    ...
    public function init(ImgurContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ImgurContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ImgurContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ImgurContext $ctx, $op, $args): array
    {
