...
class ImgurProxyFeature extends ImgurBaseFeature
{
    ...
    public function init(ImgurContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ImgurContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
