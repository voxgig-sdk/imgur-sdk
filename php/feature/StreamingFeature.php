...
class ImgurStreamingFeature extends ImgurBaseFeature
{
    ...
    private function _iterate(ImgurResult $result): \Generator
    {
    ...
    private function _streamable(ImgurContext $ctx): bool
    {
