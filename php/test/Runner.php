...
class ImgurTestRunner
{
    ...
    {
        $live = self::getenv('IMGUR_TEST_LIVE');
        $override = self::getenv('IMGUR_TEST_OVERRIDE');
        ...
        $explain = self::getenv('IMGUR_TEST_EXPLAIN');
...
class_alias('ImgurTestRunner', 'Runner');
class_alias('ImgurHelpers', 'Helpers');
