...
class PostMetaEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = ImgurSDK::test($seed, null);
        $seen = iterator_to_array($base->PostMeta(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->PostMeta(null)->stream("list", null, null) as $item) {
