...
// Imgur SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ImgurSDK::test)
...
{
    private const SDK_CLASS = 'ImgurSDK';
    ...
    private const SDK_BASE = 'imgur_sdk';
