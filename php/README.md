...
The PHP SDK for the Imgur API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Image(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->Imgur(null)->load(
    ["id" => "test01"], null
);
