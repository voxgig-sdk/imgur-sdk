...
class ImgurCacheFeature extends ImgurBaseFeature
{
    ...
    private function _through(ImgurContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
