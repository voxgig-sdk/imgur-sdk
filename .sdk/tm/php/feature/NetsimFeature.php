...
class ImgurNetsimFeature extends ImgurBaseFeature
{
    ...
    private function _simulate(ImgurContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ImgurContext $ctx, array $applied): void
    {
        $client = $this->client;
