...
class ImgurRatelimitFeature extends ImgurBaseFeature
{
    ...
    private function _acquire(ImgurContext $ctx): void
    {
    ...
    private function _track(ImgurContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
