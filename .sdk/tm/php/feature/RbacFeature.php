...
class ImgurRbacFeature extends ImgurBaseFeature
{
    ...
    private function _required(ImgurContext $ctx): ?string
    {
    ...
    private function _reject(ImgurContext $ctx, string $required): void
    {
    ...
    private function _track(ImgurContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
