...
class ImgurTimeoutFeature extends ImgurBaseFeature
{
    ...
    private function _with_timeout(ImgurContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ImgurContext $_ctx, float $ms): void
    {
        $client = $this->client;
