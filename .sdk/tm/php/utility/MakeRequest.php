...
// Imgur SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ImgurMakeRequest
{
    public static function call(ImgurContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ImgurResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ImgurResponse($fetched);
        } else {
