...
class ImgurFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ImgurSDK/1.0)';
    ...
    public static function call(ImgurContext $ctx, string $fullurl, array $fetchdef): array
    {
