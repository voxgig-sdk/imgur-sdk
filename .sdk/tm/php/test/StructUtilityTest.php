...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ImgurOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ImgurOmni::structfix($now, Struct::undef()))
                        !== json_encode(ImgurOmni::structfix($val, Struct::undef()))) {
