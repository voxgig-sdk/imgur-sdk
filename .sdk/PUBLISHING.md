...
|---|---|---|
| `ts/` | @voxgig-sdk/imgur-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/imgur-sdk \
      --repository voxgig-sdk/imgur-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/imgur-sdk` shows it, and
`npm trust revoke @voxgig-sdk/imgur-sdk --id=<id>` removes it.
