...
(0, node_test_1.describe)('PostMetaEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/post_meta/PostMetaTestData.json');
    ...
    let idmap = transform(['post_meta01', 'post_meta02', 'post_meta03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=PostMetaEntity.test.js.map