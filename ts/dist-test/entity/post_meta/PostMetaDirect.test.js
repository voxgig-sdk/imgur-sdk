...
(0, node_test_1.describe)('PostMetaDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-post_meta', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-post_meta', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["post_meta01"]))
            return;
...
function liveScenariosActive() { return false && process.env.IMGUR_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ImgurSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['IMGUR_TEST_POST_META_ENTID'];
...
//# sourceMappingURL=PostMetaDirect.test.js.map